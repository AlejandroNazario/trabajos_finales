...
def generate_dataset(nbr):
    face_classifier = cv2.CascadeClassifier(
        "C:/Users/alexc/Documents/10semestre/mtra.yanet/pythonProject/resources/haarcascade_frontalface_default.xml")
...
def train_classifier(nbr):
    dataset_dir = "C:/Users/alexc/Documents/10semestre/mtra.yanet/pythonProject/dataset"
...
if __name__ == "__main__":
    app.run(host='192.168.213.101', port=5000, debug=True)
